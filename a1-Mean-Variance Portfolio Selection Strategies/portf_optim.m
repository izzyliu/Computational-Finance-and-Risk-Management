...
strategy_names     = {'Buy and Hold' 'Equally Weighted Portfolio' 'Mininum Variance Portfolio' 'Maximum Sharpe Ratio Portfolio' 'Buy and Hold Equally Portfolio'};
...
d = portf_value{1,4};
e = portf_value{1,5};
plot(length,a,length,b,length,c,length,d,length,e); 
xlabel('Days');
ylabel('Portfolio Value');
title('Performance of the Strategies');
legend('Buy and Hold', 'Equally Weighted Portfolio', 'Minimum Variance Portfolio', 'Maximum Sharpe Ratio Portfolio', 'Buy and Hold Equally Weighted Portfolio');
...
xlabel('Periods');
ylabel('Weight');
title('Minimum Variance Strategy Dynamic Change');
...
xlabel('Periods');
ylabel('Weight');
title('Maximum Sharpe Ratio Strategy Dynamic Change');
legend(headers{1,1}(2:21));
